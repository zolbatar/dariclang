...
class FuncParameter {
public:
    FuncParameter(Reference *ref, bool is_ref, bool is_array) : ref(ref), is_ref(is_ref), is_array(is_array) {}
    ...
    bool GetLLVMType(std::vector<llvm::Type *>& types, CompilerLLVM &llvm) { return ref->GetLLVMType(is_ref, is_array, types, llvm); }
