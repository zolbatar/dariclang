...
public:
   ...
   */
    ...
    virtual std::any visitGet(DaricParser::GetContext *context) = 0;
    ...
    virtual std::any visitTypeSignatureArrayOrCollection(DaricParser::TypeSignatureArrayOrCollectionContext *context) = 0;
