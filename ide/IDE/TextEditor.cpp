...
static std::list<std::string> library = { "Sleep",
										  ...
										  "Object", "Shape", "DeleteShape", "SetCamera", "Translate", "Rotate", "Scale", "DeleteObject",
										  "DeleteAllObjects", "ShadowsOn", "ShadowsOff", "Render", "Vertex", "VertexColour",
										  ...
										  "ClearEvents", "WaitKey", "WaitKeyChar", "KeyDown", "Get", "GetChar", "MouseX", "MouseY", "MouseState",

										  "LoadSoundFont", "LoadSample", "PlaySample", "LoadMusic", "PlayMusic", "StopMusic", "SetVolume", "SetMusicVolume"
};
...
//        langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("(?:Def[ \t\n]*)([a-zA-Z_][a-zA-Z0-9_]*)", PaletteIndex::Def));
		...
		langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("&[0-9a-fA-F]+[uU]?[lL]?[lL]?", PaletteIndex::Number));
