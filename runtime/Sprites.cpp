...
extern "C" DLLEXTERN void sprites_draw(T_I handle, T_I bank, T_I x, T_I y, T_F rot, T_F scale) {
    gfx_uicheck();
    sprite.DrawSprite(handle, bank, x, y, rot, scale);
}

extern "C" DLLEXTERN void sprites_partdraw(T_I handle, T_I bank, T_I x, T_I y, T_F rot, T_F scale, T_I off_x, T_I off_y, T_I sz_x, T_I sz_y) {
    gfx_uicheck();
