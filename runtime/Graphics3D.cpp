...
extern "C" DLLEXTERN void gfx3d_camera(T_F x, T_F y, T_F z, T_F rx, T_F ry, T_F rz, T_F lx, T_F ly, T_F lz) {
    world.Camera(x, y, z, rx, ry, rz, lx, ly, lz);
}

extern "C" DLLEXTERN T_I gfx3d_object(T_I id, T_F x, T_F y, T_F z, T_F rx, T_F ry, T_F rz, T_F scale, T_I render_type) {
    return world.CreateObject(id, x, y, z, rx, ry, rz, scale, render_type);
}

extern "C" DLLEXTERN void gfx3d_translate(T_I id, T_F x, T_F y, T_F z) {
    world.ObjectTranslate(id, x, y, z);
}

extern "C" DLLEXTERN void gfx3d_rotate(T_I id, T_F x, T_F y, T_F z) {
    world.ObjectRotate(id, x, y, z);
}

extern "C" DLLEXTERN void gfx3d_scale(T_I id, T_F scale) {
    world.ObjectScale(id, scale);
}

extern "C" DLLEXTERN void gfx3d_deleteobject(T_I id) {
    world.ObjectDelete(id);
}

extern "C" DLLEXTERN void gfx3d_deleteallobjects() {
    world.ObjectDeleteAll();
}

extern "C" DLLEXTERN void gfx3d_shadowson() {
    world.shadows = true;
}

extern "C" DLLEXTERN void gfx3d_shadowsoff() {
    world.shadows = false;
}

extern "C" DLLEXTERN void gfx3d_render() {
    world.Render();
}

extern "C" DLLEXTERN void gfx3d_vertex(T_F x, T_F y, T_F z) {
    PosColorVertex pcv;
    pcv.position.x = x;
    pcv.position.y = y;
    pcv.position.z = z;
...
extern "C" DLLEXTERN void gfx3d_vertexc(T_F x, T_F y, T_F z, T_I colour) {
    PosColorVertex pcv;
    pcv.position.x = x;
    pcv.position.y = y;
    pcv.position.z = z;
...
extern "C" DLLEXTERN void gfx3d_face(T_I v1, T_I v2, T_I v3) {
    MeshTriangle t;
    t.vertex1 = v1;
    t.vertex2 = v2;
    t.vertex3 = v3;
...
extern "C" DLLEXTERN void gfx3d_facec(T_I v1, T_I v2, T_I v3, T_I colour) {
    MeshTriangle t;
    t.vertex1 = v1;
    t.vertex2 = v2;
    t.vertex3 = v3;
...
extern "C" DLLEXTERN T_I gfx3d_shape() {
    auto index = world.CreateShape();
//    std::cout << "Shape index: " << index << std::endl;
    return index;
}

extern "C" DLLEXTERN void gfx3d_shapedelete(T_I id) {
    world.DeleteShape(id);
}

extern "C" DLLEXTERN T_I gfx3d_loadmesh(T_S file) {
...
extern "C" DLLEXTERN void gfx3d_ambient(T_F r, T_F g, T_F b) {
    world.SetAmbient(r, g, b);
}

extern "C" DLLEXTERN void gfx3d_directional(T_F x, T_F y, T_F z, T_F r, T_F g, T_F b, T_F c, T_F l, T_F q) {
...
extern "C" DLLEXTERN void gfx3d_setrotate(T_F x, T_F y, T_F z, T_F vx, T_F vy, T_F vz) {
    glm::mat4 m(1.0f);
...
extern "C" DLLEXTERN T_F gfx3d_getrotatex() {
    return out.x;
}

extern "C" DLLEXTERN T_F gfx3d_getrotatey() {
    return out.y;
}

extern "C" DLLEXTERN T_F gfx3d_getrotatez() {
    return out.z;
}
